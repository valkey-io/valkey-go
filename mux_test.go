		...
		m, checkClean := setupMux([]*mockWire{
			{
				// leave first wire for pipeline calls
				DoFn: func(cmd Completed) ValkeyResult {
					return newResult(ValkeyMessage{typ: '+', string: "PIPELINED"}, nil)
				},
			},
			{
				DoFn: func(cmd Completed) ValkeyResult {
		...
		m, checkClean := setupMux([]*mockWire{
			{
				...
				DoMultiFn: func(cmd ...Completed) *valkeyresults {
					return &valkeyresults{s: []ValkeyResult{newResult(ValkeyMessage{typ: '+', string: "PIPELINED"}, nil)}}
				},
			},
			{
				DoMultiFn: func(cmd ...Completed) *valkeyresults {
					return &valkeyresults{s: []ValkeyResult{newResult(ValkeyMessage{typ: '+', string: "ACQUIRED"}, nil)}}
				},
			},
			{
				DoMultiFn: func(cmd ...Completed) *valkeyresults {

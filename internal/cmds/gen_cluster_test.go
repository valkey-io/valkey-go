...
func cluster0(s Builder) {
	...
	s.ClusterCancelmigration().All().Build()
	...
	s.ClusterMigrateslots().Slotsrange().StartSlot(1).EndSlot(1).Node().NodeId("1").Slotsrange().StartSlot(1).EndSlot(1).Node().NodeId("1").Build()
	s.ClusterMyid().Build()

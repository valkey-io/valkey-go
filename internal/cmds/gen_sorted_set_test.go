...
func sorted_set1(s Builder) {
	...
	s.Zremrangebyscore().Key("1").Min("1").Max("1").Withscores().Limit(1, 1).Build()
	s.Zremrangebyscore().Key("1").Min("1").Max("1").Withscores().Build()
	s.Zremrangebyscore().Key("1").Min("1").Max("1").Limit(1, 1).Build()

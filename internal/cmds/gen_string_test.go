...
func string0(s Builder) {
	...
	s.Set().Key("1").Value("1").Ifeq().ComparisonValue("1").Get().Build()
	s.Set().Key("1").Value("1").Ifeq().ComparisonValue("1").ExSeconds(1).Build()
	s.Set().Key("1").Value("1").Ifeq().ComparisonValue("1").PxMilliseconds(1).Build()
	s.Set().Key("1").Value("1").Ifeq().ComparisonValue("1").ExatTimestamp(1).Build()
	s.Set().Key("1").Value("1").Ifeq().ComparisonValue("1").PxatMillisecondsTimestamp(1).Build()
	s.Set().Key("1").Value("1").Ifeq().ComparisonValue("1").Keepttl().Build()
	s.Set().Key("1").Value("1").Ifeq().ComparisonValue("1").Ex(time.Second).Build()
	s.Set().Key("1").Value("1").Ifeq().ComparisonValue("1").Px(time.Second).Build()
	s.Set().Key("1").Value("1").Ifeq().ComparisonValue("1").Exat(time.Now()).Build()
	s.Set().Key("1").Value("1").Ifeq().ComparisonValue("1").Pxat(time.Now()).Build()
	s.Set().Key("1").Value("1").Ifeq().ComparisonValue("1").Build()

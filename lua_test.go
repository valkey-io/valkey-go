...
func (c *client) DoStream(_ context.Context, _ Completed) (resp ValkeyResultStream) {
	return ValkeyResultStream{}
}

func (c *client) DoMultiStream(_ context.Context, _ ...Completed) (resp MultiValkeyResultStream) {

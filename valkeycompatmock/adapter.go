...
func (m *ClientMock) ExpectGet(key string) *ExpectedString {
	e := m.push(mock.Match("GET", key), mock.Result(mock.ValkeyNil()))
...
func (m *ClientMock) ExpectGetSet(key string, value any) *ExpectedString {
	e := m.push(mock.Match("GETSET", key, str(value)), mock.Result(mock.ValkeyNil()))
	return &ExpectedString{exp: e}
}

func (m *ClientMock) ExpectAppend(key, value string) *ExpectedInt {
	e := m.push(mock.Match("APPEND", key, value), mock.Result(mock.ValkeyInt64(0)))
	return &ExpectedInt{exp: e}
}

func (m *ClientMock) ExpectStrLen(key string) *ExpectedInt {
	e := m.push(mock.Match("STRLEN", key), mock.Result(mock.ValkeyInt64(0)))
	return &ExpectedInt{exp: e}
}
...
func (m *ClientMock) ExpectType(key string) *ExpectedStatus {
	e := m.push(mock.Match("TYPE", key), mock.Result(mock.ValkeyString("none")))
	return &ExpectedStatus{exp: e}
}

func (m *ClientMock) ExpectTTL(key string) *ExpectedDuration {
	e := m.push(mock.Match("TTL", key), mock.Result(mock.ValkeyInt64(-2)))
...
func (m *ClientMock) ExpectExpire(key string, expiration time.Duration) *ExpectedBool {
	e := m.push(mock.Match("EXPIRE", key, strconv.FormatInt(formatSec(expiration), 10)), mock.Result(mock.ValkeyBool(false)))
	return &ExpectedBool{exp: e}
}

func (m *ClientMock) ExpectPing() *ExpectedStatus {
	e := m.push(mock.Match("PING"), mock.Result(mock.ValkeyString("PONG")))
	return &ExpectedStatus{exp: e}
}

func (m *ClientMock) ExpectEcho(message any) *ExpectedString {
	e := m.push(mock.Match("ECHO", str(message)), mock.Result(mock.ValkeyString("")))
	return &ExpectedString{exp: e}
}

func (m *ClientMock) ExpectIncr(key string) *ExpectedInt {
	e := m.push(mock.Match("INCR", key), mock.Result(mock.ValkeyInt64(0)))
	return &ExpectedInt{exp: e}
}

func (m *ClientMock) ExpectIncrBy(key string, value int64) *ExpectedInt {
	e := m.push(mock.Match("INCRBY", key, strconv.FormatInt(value, 10)), mock.Result(mock.ValkeyInt64(0)))
	return &ExpectedInt{exp: e}
}

func (m *ClientMock) ExpectDecr(key string) *ExpectedInt {
	e := m.push(mock.Match("DECR", key), mock.Result(mock.ValkeyInt64(0)))
	return &ExpectedInt{exp: e}
}

func (m *ClientMock) ExpectDecrBy(key string, value int64) *ExpectedInt {
	e := m.push(mock.Match("DECRBY", key, strconv.FormatInt(value, 10)), mock.Result(mock.ValkeyInt64(0)))
	return &ExpectedInt{exp: e}
}

func (m *ClientMock) ExpectMGet(keys ...string) *ExpectedSlice {
	args := append([]string{"MGET"}, keys...)
	e := m.push(mock.Match(args...), mock.Result(mock.ValkeyArray()))
...
func (m *ClientMock) ExpectHGet(key, field string) *ExpectedString {
	e := m.push(mock.Match("HGET", key, field), mock.Result(mock.ValkeyNil()))
	return &ExpectedString{exp: e}
}
...
func (m *ClientMock) ExpectHGetAll(key string) *ExpectedStringStringMap {
	e := m.push(mock.Match("HGETALL", key), mock.Result(mock.ValkeyMap(map[string]valkey.ValkeyMessage{})))
...
func (m *ClientMock) ExpectLPop(key string) *ExpectedString {
	e := m.push(mock.Match("LPOP", key), mock.Result(mock.ValkeyNil()))
	return &ExpectedString{exp: e}
}

func (m *ClientMock) ExpectRPop(key string) *ExpectedString {
	e := m.push(mock.Match("RPOP", key), mock.Result(mock.ValkeyNil()))
	return &ExpectedString{exp: e}
}

func (m *ClientMock) ExpectLLen(key string) *ExpectedInt {
	e := m.push(mock.Match("LLEN", key), mock.Result(mock.ValkeyInt64(0)))
	return &ExpectedInt{exp: e}
}
...
func (m *ClientMock) ExpectSMembers(key string) *ExpectedStringSlice {
	e := m.push(mock.Match("SMEMBERS", key), mock.Result(mock.ValkeyArray()))

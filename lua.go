...
// WithLoadSha1 enables loading of SHA-1 from Valkey via SCRIPT LOAD instead of calculating
...
// By default, SHA-1 is calculated client-side. Use WithLoadSha1() option to load SHA-1 from Valkey instead.

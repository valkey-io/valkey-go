...
var shardsResp = newResult(ValkeyMessage{typ: typeArray, values: []ValkeyMessage{
	{typ: typeMap, values: []ValkeyMessage{
		...
		{typ: typeArray, values: []ValkeyMessage{
			{typ: typeMap, values: []ValkeyMessage{ // failed master
...
var shardsRespTls = newResult(ValkeyMessage{typ: typeArray, values: []ValkeyMessage{
	{typ: typeMap, values: []ValkeyMessage{
		...
		{typ: typeArray, values: []ValkeyMessage{
			...
			{typ: typeMap, values: []ValkeyMessage{ // failed master, tls + port
				{typ: typeBlobString, string: "id"},
				{typ: typeBlobString, string: ""},
				...
				return &mockConn{DoFn: func(cmd Completed) ValkeyResult {
					...
					case 1:
						return &valkeyresults{s: []ValkeyResult{
							...
							newResult(ValkeyMessage{typ: '+', string: "OK"}, nil),
							newResult(ValkeyMessage{typ: '+', string: "QUEUED"}, nil),
							newResult(ValkeyMessage{typ: '-', string: "MOVED 0 :1"}, nil),
							newResult(ValkeyMessage{typ: '-', string: "EXECABORT"}, nil),
							newResult(ValkeyMessage{typ: '+', string: "4"}, nil),
							newResult(ValkeyMessage{typ: '+', string: "OK"}, nil),
							newResult(ValkeyMessage{typ: '-', string: "MOVED 0 :1"}, nil),
							newResult(ValkeyMessage{typ: '+', string: "QUEUED"}, nil),
							newResult(ValkeyMessage{typ: '-', string: "EXECABORT"}, nil),
							newResult(ValkeyMessage{typ: '+', string: "7"}, nil),
						}}
					case 2:
						return &valkeyresults{s: []ValkeyResult{
							newResult(ValkeyMessage{typ: '+', string: "OK"}, nil),
				...
				return &mockConn{DoFn: func(cmd Completed) ValkeyResult {
					...
					case 1:
						return &valkeyresults{s: []ValkeyResult{
							newResult(ValkeyMessage{typ: '+', string: "1"}, nil),
							newResult(ValkeyMessage{typ: '+', string: "OK"}, nil),
							newResult(ValkeyMessage{typ: '-', string: "ERR Command not allowed inside a transaction"}, nil),
							newResult(ValkeyMessage{typ: '-', string: "MOVED 0 :1"}, nil),
							newResult(ValkeyMessage{typ: '-', string: "MOVED 0 :1"}, nil),
							newResult(ValkeyMessage{typ: '-', string: "EXECABORT"}, nil),
							newResult(ValkeyMessage{typ: '-', string: "MOVED 0 :1"}, nil),
...
func TestClusterClientMovedRetry(t *testing.T) {
	...
	t.Run("DoMulti Retry on MOVED", func(t *testing.T) {
		...
		m.DoMultiFn = func(multi ...Completed) *valkeyresults {
			attempts++
			if attempts == 1 {
				return &valkeyresults{s: []ValkeyResult{newResult(ValkeyMessage{typ: '-', string: "MOVED 0 127.0.0.1"}, nil)}}
			}
			return &valkeyresults{s: []ValkeyResult{newResult(ValkeyMessage{typ: '+', string: "OK"}, nil)}}
		}
	...
	t.Run("DoMulti Retry on ASK", func(t *testing.T) {
		...
		m.DoMultiFn = func(multi ...Completed) *valkeyresults {
			attempts++
			if attempts == 1 {
				return &valkeyresults{s: []ValkeyResult{newResult(ValkeyMessage{typ: '-', string: "ASK 0 127.0.0.1"}, nil)}}
			}
			return &valkeyresults{s: []ValkeyResult{newResult(ValkeyMessage{typ: '+', string: "OK"}, nil), newResult(ValkeyMessage{typ: '+', string: "OK"}, nil)}}
		}
...
func TestClusterClientCacheASKRetry(t *testing.T) {
	...
	t.Run("DoCache Retry on ASK", func(t *testing.T) {
		...
		attempts := 0
		m.DoCacheFn = func(cmd Cacheable, ttl time.Duration) ValkeyResult {
			return newResult(ValkeyMessage{typ: '-', string: "ASK 0 :0"}, nil)
		}
		m.DoMultiFn = func(multi ...Completed) *valkeyresults {
			attempts++
			if attempts == 1 {
				return &valkeyresults{s: []ValkeyResult{{}, {}, {}, {}, newResult(ValkeyMessage{typ: '-', string: "ASK 0 :0"}, nil), newResult(ValkeyMessage{typ: '_'}, nil)}}
			}
			return &valkeyresults{s: []ValkeyResult{{}, {}, {}, {}, {}, newResult(ValkeyMessage{typ: '*', values: []ValkeyMessage{{}, {}, {}, {}, {}, {typ: '+', string: "OK"}}}, nil)}}
		}
	...
	t.Run("DoMultiCache Retry on ASK", func(t *testing.T) {
		...
		attempts := 0
		m.DoMultiCacheFn = func(multi ...CacheableTTL) *valkeyresults {
			return &valkeyresults{s: []ValkeyResult{newResult(ValkeyMessage{typ: '-', string: "ASK 0 :0"}, nil)}}
		}
		m.DoMultiFn = func(multi ...Completed) *valkeyresults {
			attempts++
			if attempts == 1 {
			...
			return &valkeyresults{s: []ValkeyResult{{}, {}, {}, {}, {}, newResult(ValkeyMessage{typ: '*', values: []ValkeyMessage{{}, {}, {}, {}, {}, ValkeyMessage{typ: '+', string: "OK"}}}, nil)}}
		}
